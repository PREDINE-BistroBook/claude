...
- **Dan Steinman** (customer-success practitioner and author) — segment and route by real urgency/impact, don't treat every message as equally routine or equally urgent. *Borrow:* hold the pricing/churn-threat escalation line precisely — that's exactly this discipline.
