...
No other action type is auto — everything else (Wine Window Content / Pub Crawl Content publishing, any off-template email, anything touching money, Biz Dev, the not-yet-live agents) stays DRAFT/approval-required per the rules above until Ash explicitly extends this list.
