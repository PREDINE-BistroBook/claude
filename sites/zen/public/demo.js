  ...
  const Demo = {
    handle(method, path, body) {
      ...
      if (path.startsWith("/api/admin/")) {
        ...
        if (path === "/api/admin/therapists" && method === "POST") { therapists.push({ id: "t" + (therapists.length + 1), city: city || body.city, name: body.name, bio: body.bio || "", photo: body.photo || null, languages: body.languages || "", active: body.active === false ? 0 : 1, sort: body.sort || 0 }); return { ok: true }; }
