...
CREATE TABLE IF NOT EXISTS therapists (id TEXT PRIMARY KEY, city TEXT NOT NULL, name TEXT NOT NULL, bio TEXT, photo TEXT, languages TEXT, active INTEGER DEFAULT 1, sort INTEGER DEFAULT 0, created_at TEXT DEFAULT (datetime('now')), admin_id TEXT, area TEXT, address TEXT, maps_url TEXT, title TEXT, story TEXT, certs TEXT, instagram TEXT);
